 ...
 */
public class AlteraCliente extends Application {
    ...
    public AlteraCliente(Cliente c) {
        AlteraClienteController.setCliente2(c);
    }
    ...
    public void start(Stage stage) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/View/AlteraCliente.fxml"));
