 ...
 */
public class CadastrarVendedor extends Application {
    ...
    public void start(Stage stage) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/View/CadastrarVendedor.fxml"));
